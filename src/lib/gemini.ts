...
// "gemini-2.5-flash" was retired for new API keys/projects; "gemini-flash-latest"
// is Google's alias that always resolves to their current recommended flash model.
